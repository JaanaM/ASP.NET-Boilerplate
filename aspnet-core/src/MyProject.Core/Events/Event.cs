...
{
    /// <summary>
    /// IMustHaveTenant is an interface of ASP.NET Boilerplate (ABP) framework and ensures that this entity is per tenant. This is needed for multi-tenancy. 
    /// Event inherits from FullAuditedEntity which contains creation, modification and deletion audit columns.
    /// </summary>
    [Table("AppEvents")]
    public class Event : FullAuditedEntity<Guid>, IMustHaveTenant
    {
        ...
        //private setters don't work well with Entity Framework Core since Entity Framework Core can not set privates when retrieving an entity from database
